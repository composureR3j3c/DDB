...
var finalRows;
  var bodyTable1 = bodyTable.map((res) => {
    ...
    return (
      ...
      <td className="p-2">{res.CANDIDATE_ID}</td>
      <td className="p-2">{res.ELECTEDDATE}</td>
      <td className="p-2">{res.ID}</td>

      <td className="p-2"> {res.REGION}</td>
      <td className="p-2"> {res.VOTER_ID}</td>
    </tr>
  ...
  var bodyHeader1;
    ...
    <tr>
      <th scope="col">
        <p className="p-2">CANDIDATE_ID</p>
      </th>
      <th scope="col">
        <p className="p-2">ELECTEDDATE</p>
      </th>
      <th scope="col">
